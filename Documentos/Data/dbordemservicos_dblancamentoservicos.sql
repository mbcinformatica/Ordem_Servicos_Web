...
--
-- Table structure for table `dblancamentoservicos`
--

DROP TABLE IF EXISTS `dblancamentoservicos`;
...
CREATE TABLE `dblancamentoservicos` (
  ...
  `DescricaoDefeito` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
--
-- Dumping data for table `dblancamentoservicos`
--

LOCK TABLES `dblancamentoservicos` WRITE;
/*!40000 ALTER TABLE `dblancamentoservicos` DISABLE KEYS */;
/*!40000 ALTER TABLE `dblancamentoservicos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-04-25 23:38:48
